...
MOFAobject <- invisible(run_mofa(MOFAobject, use_basilisk = T))
```
...
It is important to see if the model fits the data well. We can do this by looking at how much of the data's changes the model can explain. The results change based on the kind of data, how many samples we have, and how many factors we use.
